...
class  Header
{
    ...
    public function __construct()
    {
        ...
        $listaOrdenada = [
            ...
            array('url' => URL . 'src/#', 'titulo' => 'Variables'),
            array('url' => URL . 'src/#', 'titulo' => 'Scope Variable php'),
            array('url' => URL . 'src/#', 'titulo' => 'Variables Glovales'),
            array('url' => URL . 'src/#', 'titulo' => 'Re-Direccion'),
